...
(() => {
  const pages = {
    ...
    '/privacy': { zh: { title: '隐私政策 - Token NX', heading: 'Token NX 隐私政策', summary: '本页面说明 Token NX 在提供账户、计费和模型调用服务时如何处理与保护必要数据。' }, en: { title: 'Privacy Policy - Token NX', heading: 'Token NX Privacy Policy', summary: 'This page explains how Token NX handles and protects necessary data while providing accounts, billing, and model access.' } },
