...
describe('页面主链冒烟场景', () => {
  ...
  it('公开首页严格展示手稿中的七段结构', () => {
    ...
    expect(document.querySelector('.header-trial-badge strong')).toHaveTextContent('买一赠一')
    expect(document.querySelector('.header-trial-badge em')).toHaveTextContent('限量')
    expect(screen.getByText('买一赠一')).toBeInTheDocument()
