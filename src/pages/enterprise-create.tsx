...
function EnterpriseRecognitionLoading() {
  ...
  return <div className="enterprise-recognition-loading" role="status" aria-live="polite">
    <div className="enterprise-recognition-loading-head"><span className="records-loading-spinner" aria-hidden="true" /><div><strong>{t('console.enterpriseCreate.recognitionLoading')}</strong><span>{t('console.enterpriseCreate.recognitionLoadingHint')}</span></div></div>
