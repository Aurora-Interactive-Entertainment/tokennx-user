...
function UsageSummaryPage({ enterpriseRoute }: { enterpriseRoute: boolean }) {
  ...
  const granularityLabel = t('console.usage.timeGranularity')
  const granularityLabels = { hour: t('console.usage.granularityHour'), day: t('console.usage.granularityDay'), week: t('console.usage.granularityWeek'), month: t('console.usage.granularityMonth') }
