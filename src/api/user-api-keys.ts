...
export function createEnterpriseApiKey(
  ...
  return fetchAuthenticatedJson<CreatedUserApiKey>(enterpriseApiKeyPath(context), { method: "POST", body: input });
}
...
export function batchManageEnterpriseApiKeys(
  ...
  return fetchAuthenticatedJson<EnterpriseApiKeyBatchResponse>(`${enterpriseApiKeyPath(context)}/batch`, { method: "POST", body: input });
}
...
export function createUserApiKey(
  ...
  return fetchAuthenticatedJson<CreatedUserApiKey>(
...
export function updateUserApiKey(
  ...
  return fetchAuthenticatedJson<UserApiKey>(
...
export function getUserApiKeyActivity(
  ...
  return fetchAuthenticatedJson<UserApiKeyActivityList>(
    `${API_KEY_PATH}/${encodeURIComponent(keyId)}/activity?${contextQuery(context, { limit })}`,
  );
}
