...
describe('控制台导航路径匹配', () => {
  ...
  it('展示侧栏入口、个人空间标识和全局客服入口', () => {
    ...
    expect(navigation).not.toHaveTextContent('图片生成')
    expect(navigation).not.toHaveTextContent('认证返现')
  ...
  it('企业导航过滤器按角色组权限显示对应菜单并把费用归入企业管理', () => {
    ...
    expect(isEnterprisePermissionPath('/console/purchase')).toBe(true)
...
describe('已登录用户菜单', () => {
  it('显示参考站的账号信息、分组入口和退出登录', async () => {
    ...
    expect(menu).not.toHaveTextContent('图片生成')
